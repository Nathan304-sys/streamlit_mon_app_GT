...
if page == "Prédiction":
    ...
    def encode2(df):
        ...
        numeric_features = [
                        'total_echeance', 'capital_rembourse', 'nbre_ech',
                        'taux_interet', 'age_credit_jours', 'nb_cpt', 'cum_taux_paiement'] 
        #'echa_impaye_avant', 'montant_credit', 'capital_restant'
    ...
    #    'cum_taux_paiement', 'statut'
        segment = st.selectbox(
            ...
            ['GE', 'ME', 'PE', 'INS', 'TPE', 'Other', 'PAR'], #other = 'ASS'
        ...
        forme_juridique = st.selectbox(
            "Forme juridique",
            ['SA','SARL', 'EURL', 'Other'] #Autre= 'GIE', 'SAS', 'ASCO', 'SP', 'SCI'
        )
        ...
        secteur_risque = st.selectbox(
            ...
            ['Commerce', 'Secteur Public', 'Activités Agro-Pastorales',
             ...
             'Energie', 'Production Autres Services', 'Transports']) # Other =,'Activités Financières et Assurance', 'Télécommunications'
    ...
    if st.button("Prédire le risque de défaut"):
        ...
        df_prediction = pd.DataFrame({ 
                ...
                'cat_age_entreprise':cat_age_entreprise},index=[1] ) #,index=[n_ech]   
            #"echa_impaye_avant":ech_impaye_avant, 'montant_credit':montant_credit,  'capital_restant':capital_restant,
        #, 'Retard':statut_retard,
